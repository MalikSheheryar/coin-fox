...
const strings = {
  en: {
    ...
    copylink:
      'Copy the URL below to import your current portfolio to another device',
    getlink: 'Get Link',
    // Menu
  ...
  de: {
    ...
    importexport: 'Import / Export Portfolio',
    copylink:
      'Kopieren Sie die URL unten, um Ihr aktuelles Portfolio auf ein anderes Gerät zu importieren',
    getlink: 'Link holen',
    // Menu
  ...
  fr: {
    ...
    // App
    fillticker:
      "S'il vous plaît remplir le ticker, la base des coûts et la tenue",
    ...
    importexport: 'Import / Export Portfolio',
    copylink:
      "Copiez l'URL ci-dessous pour importer votre portefeuille actuel vers un autre appareil",
